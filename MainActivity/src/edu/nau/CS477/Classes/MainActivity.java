...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(contactDB.getAllContacts().size() == 0){
	        ...
	        contactDB.addContact(new ContactObject("JD","Knapp (My Account)","jdk85@nau.edu"));
        ...
        for (ContactObject cn : contacts) {
            String log = "Id: "+cn.getId()+" ,Name: " + cn.getFullName() + " ,Email: " + cn.getEmailAddr() + " ,IP: " + cn.getCurrentIP();
                // Writing Contacts to
        Log.d("Name: ", log);
        }
        */
